  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        Welcome to <Link color="pink.800" href="https://nextjs.org">Next.js!</Link>
        </Heading>
        ...
        <Flex flexWrap="wrap" alignItems="center" justifyContent="center" maxW="800px" mt="10">
          <Box as="a" href="https://nextjs.org/docs" p="6" m="4" borderWidth="1px" bg="pink.100" rounded="lg" flexBasis={['auto', '45%']}>
          ...
          <Box as="a" href="https://nextjs.org/learn" p="6" m="4" borderWidth="1px" bg="pink.100" rounded="lg" flexBasis={['auto', '45%']}>
          ...
          <Box as="a" href="https://github.com/vercel/next.js/tree/master/examples" p="6" m="4" borderWidth="1px" bg="pink.100" rounded="lg" flexBasis={['auto', '45%']}>
          ...
          <Box as="a" href="https://vercel.com/new?utm_source=create-next-app&utm_medium=default-template&utm_campaign=create-next-app" p="6" m="4" borderWidth="1px" bg="pink.100" rounded="lg" flexBasis={['auto', '45%']}>
